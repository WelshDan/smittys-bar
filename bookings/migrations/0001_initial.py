    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.TimeField(default=10)),
                ('end_time', models.TimeField(default=10)),
                ('active_booking', models.BooleanField(default=True)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('email', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.customer')),
            ],
        ),
    ]
